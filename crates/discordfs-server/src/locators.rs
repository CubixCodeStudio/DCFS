...
use discordfs_db::{MetadataRepository, ObjectLocatorRecord, RepositoryError};
use discordfs_discord::{DiscordLocator, LocatorStore};
use std::sync::Arc;
...
mod tests {
    use super::*;
    use discordfs_db::MemoryMetadataRepository;
