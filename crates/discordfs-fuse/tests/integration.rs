//! Integration tests for DiscordFS FUSE operations.
//!
...
use discordfs_protocol::{CreateNodeRequest, NameBytes, PatchNodeRequest, RenameNodeRequest};
use uuid::Uuid;
...
async fn create_file(
    ...
    parent_id: Uuid,
    name: &[u8],
) -> discordfs_protocol::NodeResponse {
    let req = CreateNodeRequest {
        parent_id,
