...
use dcfs_db::RepositoryError;
use dcfs_objectstore::ObjectStoreError;
...
impl From<dcfs_core::NodeNameError> for AppError {
    fn from(err: dcfs_core::NodeNameError) -> Self {
